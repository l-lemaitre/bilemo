 ...
 */
final class Version20230305161805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD customer_id INT NOT NULL, ADD registration_date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP customer_id, DROP registration_date');
    }
}
